  ...
  factory ContactPhotoQuery() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.nitishk1316.com/queryContactPhoto",
...
class ContactQuery {
  ...
  factory ContactQuery() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.nitishk1316.com/queryContact", const JSONMethodCodec());
...
class UserProfileProvider {
  ...
  factory UserProfileProvider() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.nitishk1316.com/userProfile", const JSONMethodCodec());
