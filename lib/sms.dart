...
library sms_otp_reader;

import 'dart:async';

import 'package:flutter/foundation.dart';
import 'package:flutter/services.dart';
import 'package:sms_otp_reader/contact.dart';
import 'package:sms_otp_reader/globals.dart';
  ...
  factory SmsReceiver() {
    if (_instance == null) {
      final EventChannel eventChannel = const EventChannel(
          "plugins.nitishk1316.com/recvSMS", const JSONMethodCodec());
  ...
  factory SmsSender() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.nitishk1316.com/sendSMS", const JSONMethodCodec());
      final EventChannel stateChannel = const EventChannel(
          "plugins.nitishk1316.com/statusSMS", const JSONMethodCodec());
...
class SmsQuery {
  ...
  factory SmsQuery() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.nitishk1316.com/querySMS", const JSONMethodCodec());
...
class SimCardsProvider {
  ...
  factory SimCardsProvider() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.nitishk1316.com/simCards", const JSONMethodCodec());
